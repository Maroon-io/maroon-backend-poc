...
const LimitOrder: React.FC<LimitOrderProps> = ({
  ...
  const [limitPrice, setLimitPrice] = useState((1 / BTC_PRICE).toString());
  ...
  return (
    <TradeWrapper>
      ...
      <InputContainer>
        <InputLabel htmlFor="">Limit price</InputLabel>
        <InputWrapper>
          <PriceInput
            value={limitPrice}
      ...
      <InputContainer>
        ...
        <InputWrapper>
          ...
          <StyledInput
            ...
            value={
              (isSwapped
                ? parseFloat(sellAmount) / parseFloat(limitPrice)
                : parseFloat(sellAmount) * parseFloat(limitPrice)) || 0
            }
          />
        </InputWrapper>
